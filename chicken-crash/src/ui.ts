  ...
  private ensureShell() {
    ...
    this.root.innerHTML = `
      ...
      <section class="live-wins">
        <div><strong>Live wins:</strong> <i></i> <strong>Online:</strong>&nbsp; <span class="online"></span></div>
        <div class="live-row">
          <b class="avatar">●</b><strong></strong><em></em>
        </div>
      </section>
      <main id="canvas-host"></main>
      <div class="final-win-slot"></div>
      <section class="controls-shell">
        <div class="controls round-ready"></div>
      </section>`;
